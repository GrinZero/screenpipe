...
export const PermissionButtons: React.FC<PermissionButtonsProps> = ({
  ...
  const t = useTranslations("permissionUi");
  const p2 = useTranslations("permissionUi3");
  ...
  const handlePermissionButton = async () => {
    try {
      ...
      toast({
        title: t("error"),
        description: t("requestFailed", { type }),
        variant: "destructive",
        duration: 3000,
      });
    }
  ...
  const handleOpenPermissionSettings = async () => {
    try {
      ...
      toast({
        title: t("error"),
        description: t("openSettingsFailed", { type }),
        variant: "destructive",
        duration: 3000,
      });
    }
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <Button
        ...
        title={p2("openSettings", { type })}
        aria-label={p2("openPermissionSettings", { type })}
        disabled={isDisabled}
      >
