...
export function InputMonitoringPanel({
  ...
  const u = useTranslations("miscUi5");
  ...
  return (
    <div className="space-y-3">
      ...
      <p className="text-xs text-muted-foreground">{u("inputPromptHint")}</p>

      {suspectedGhost && !granted ? (
        <div className="rounded-md border border-red-500/30 bg-red-500/5 px-3 py-2">
          <p className="text-xs text-red-700 dark:text-red-400">{u("permissionNotActivated")}</p>
        </div>
      ) : null}
