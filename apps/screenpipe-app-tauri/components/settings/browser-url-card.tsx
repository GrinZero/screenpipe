...
export function BrowserUrlCard({ onStatusChange }: BrowserUrlCardProps) {
  const bu = useTranslations("browserUi2");
  const bu3 = useTranslations("browserUi3");
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    >
                      ...
                      {hasPromptableBrowser
                        ? bu3("requestPermission")
                        : bu3("openAutomationSettings")}
                    </Button>
                  </div>
                )}
                ...
                <div className="space-y-1.5">
                  {browsers.map((b) => (
                    ...
                    >
                      ...
                      {b.status === "granted" ? (
                        <span className="text-[10px] text-green-600">{bu("enabled")}</span>
                      ) : b.status === "denied" ? (
                        <Button
                          variant="ghost"
                          size="sm"
